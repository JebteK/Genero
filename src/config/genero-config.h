/* src/config/genero-config.h.  Generated from genero-config.h.in by configure.  */
/* src/config/genero-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GNRO_CONFIG_H

#define GNRO_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://genero.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Genero Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Genero Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "genero"
