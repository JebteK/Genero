...
// Copyright (c) 2018 The Genero developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000007e8f75cec1685d947a950d6da1a735d3246b54662632409b3e8116f6a69"));
;
...
public:
	...
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        vSeeds.push_back(CDNSSeedData("seed1.genero.pro", "seed1.genero.pro"));
        vSeeds.push_back(CDNSSeedData("seed2.genero.pro", "seed2.genero.pro"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
